    ...
    isCollapsed = () => {
        ...
        for (let i=0; i<snake.length-3; i++) {
            if ((head.x === snake[i].x) &&(head.y === snake[i].y)) {
                ...
                alert(`Game over! Score: ${snake.length*10}`)
            }
        }
    }
    ...
    render() {
        ...
        return (
            <div className="a">
                <ul>
                    <li><h2>Snake</h2></li>
                    <li>Press the space key to pause the game.</li>
                    <li>Press the arrow keys to change direction/unpause.</li>
                    <li>Current score: {this.state.snake.length}0</li>
                </ul>
